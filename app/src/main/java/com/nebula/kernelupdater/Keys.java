...
public class Keys {
    ...
    public static String DEFAULT_SOURCE = "http://lightningbolt.duckdns.org/~eliminater74/NebulaKernel_Releases.txt";
    public static String SOURCE_CODE = "https://github.com/Eliminater74/NebulaKernel";
    public static String TAG_NOTIF = "NEBULA.KERNELUPDATER.UPDNOTIF";
    public static String VALIDITY_KEY = "::COM.NEBULA.KERNELUPDATER::";
