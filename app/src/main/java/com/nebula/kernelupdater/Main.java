...
public class Main extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ebula Kernel Updater");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_exit:
                //   Intent i = new Intent(Main.this, Exit.class);
                System.exit(0);
                return true;
        }
        return false;
    ...
    private void showAboutDialog() {
        ...
        text5.setTextAppearance(this, android.R.style.TextAppearance_Small);
        text5.setTypeface(Typeface.createFromAsset(getAssets(), "Roboto-Regular.ttf"));
        text5.setText(getString(R.string.dialog_content_about2, "Eliminater74"));
        contentView.addView(text5, params);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.nebula.kernelupdater/http/host/path")
        );
